...
public class DrumKit implements MouseListener {
	...
	frame.setVisible(true);	// 2. Make the frame visible and
		...
		String drum = "drum.jpg";// 8. Put the name of your image file in a String variable.

		// 9. Edit the next line to use your String variable
		drumLabelWithImage=createLabelImage(drum);// drumLabelWithImage = createLabelImage(drumImageString);

		panel.add(drumLabelWithImage);// 10. Add the image to the panel
		...
		//drumLabelWithImage.addMouseListener(l);// 13. add this mouse listener to drumLabelWithImage
